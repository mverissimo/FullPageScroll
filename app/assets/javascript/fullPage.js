...
var SimpleFs = function(element, options) {
  ...
  var move = function(index) {
    ...
    var webkit = '-webkit-transform: translate3d(0, ' + (index) * -height + 'px, 0); -webkit-transition: -webkit-transform ' + settings.animationDuration + 'ms ' + settings.animationTiming + ';';
    var ms = ' -ms-transform: translate3d(0, ' + (index) * -height + 'px, 0); -ms-transition: -ms-transform ' + settings.animationDuration + 'ms ' + settings.animationTiming + ';';
    var moz = '-moz-transform: translate3d(0, ' + (index) * -height + 'px, 0); -moz-transition: -moz-transform ' + settings.animationDuration + 'ms ' + settings.animationTiming + ';';
    var normal = 'transform: translate3d(0, ' + (index) * -height + 'px, 0); transition: transform ' + settings.animationTime + 'ms ' + settings.easing + ';';
